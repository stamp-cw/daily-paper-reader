...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-01 21:00:18 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Elliptical Regularized Hotelling Tests for High-Dimensional Change-Point Detection》（8.0/10）</p>
<p>速读：《Visibility graph-based characterization of extreme values in time series》（7.0/10）, 《Monitoring Post-Disaster Urban Recovery Using High-Resolution SAR Time Series and Unsupervised Learning: Evidence from the 2023 Türkiye-Syria Earthquake》（6.0/10）, 《FootprintNet: State-Transition-Guided Dynamic Footprint Learning for Multi-temporal Remote Sensing Change Detection》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Elliptical Regularized Hotelling Tests for High-Dimensional Change-Point Detection">Elliptical Regularized Hotelling Tests for High-Dimensional Change-Point Detection</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Visibility graph-based characterization of extreme values in time series">Visibility graph-based characterization of extreme values in time series</span></li><li><span class="dpr-home-dashboard-paper-title" title="Monitoring Post-Disaster Urban Recovery Using High-Resolution SAR Time Series and Unsupervised Learning: Evidence from the 2023 Türkiye-Syria Earthquake">Monitoring Post-Disaster Urban Recovery Using High-Resolution SAR Time Series and Unsupervised Learning: Evidence from the 2023 Türkiye-Syria Earthquake</span></li><li><span class="dpr-home-dashboard-paper-title" title="FootprintNet: State-Transition-Guided Dynamic Footprint Learning for Multi-temporal Remote Sensing Change Detection">FootprintNet: State-Transition-Guided Dynamic Footprint Learning for Multi-temporal Remote Sensing Change Detection</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">landslide <strong>4</strong></span></div>
</section>
</div>
